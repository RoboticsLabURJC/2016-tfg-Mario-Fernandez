...
\usepackage[pdftex,
            pdfauthor={Mario Fernández Guerrero},
            pdftitle={Aplicación web para gestión de clases particulares.},
...
\include{Capitulos/Infraestructura}
\include{Capitulos/Aplicacion}
\include{Capitulos/Despliegue}
