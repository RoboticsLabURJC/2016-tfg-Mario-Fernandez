        ...
        execute: function() {
            DashboardComponent = (function () {
                ...
                DashboardComponent.prototype.search = function () {
                    var _this = this;
                    this.books = [];
                    this._heroService.getAllPharmacy().subscribe(function (books) { return _this.books = books; }, function (error) { return console.error(error); });
                };
                DashboardComponent.prototype.gotoDetail = function (hero) {
                    var link = ['HeroDetail', { id: hero.year }];
